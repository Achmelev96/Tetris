...
public class Render {
    ...
    /**
     * The Render class is responsible for rendering the Tetris gameplay using JavaFX.
     * Contains methods for:
     * * <ul>
     * * <li>Drawing Figures by coordinates and color</li>
     * * <li>Redrawing the game canvas based on the current state of the grid</li>
     * * <li>Displaying messages (Game Over, Restart)
     * * </ul>
     * Contains templates of basic Figures and a method for randomly selecting one of them.
     */
    ...
    // Converts a matrix representation of a Figure into a list of coordinates
    ...
    // Returns a random Figure from the available ones
    ...
    // Returns the color for a given Figure.
